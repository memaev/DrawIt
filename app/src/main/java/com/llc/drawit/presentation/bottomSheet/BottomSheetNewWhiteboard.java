    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding.btnCreateWhiteboard.setOnClickListener(v -> {
            ...
            if (whiteboardName.isEmpty()) {
                Toast.makeText(requireContext(), "Введите название новой доски", Toast.LENGTH_SHORT).show();
                return;
            }
            // запускаем создание новой доски
            viewModel.createWhiteboard(whiteboardName, data -> {
                ...
                Toast.makeText(requireContext(), "Новая доска успешно создана", Toast.LENGTH_SHORT).show();
